...
auther use the fact that $ \pi_{i+1} = \underset{\pi}{argmax} (L_\pi_i) $

$ ((\pi) CD_{KL}^{max}(\pi_i , \pi)) $ is one of form of lagrange mulifiplier formula, they manipulate term C to converge more faster with take a risk of little distributional shift.
